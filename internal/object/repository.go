...
type Usecase interface {
	PresignPut(ctx context.Context, tenantID, folderID, name string, size int64, contentType string, principalID string) (*PresignResult, error)
	Complete(ctx context.Context, tenantID, fileID, etag string) (*domain.Object, error)
	DirectUpload(ctx context.Context, tenantID, folderID, name, contentType string, r io.Reader, size int64, principalID string) (*domain.Object, error)
	MultipartInit(ctx context.Context, tenantID, folderID, name string, size int64, contentType string, principalID string) (*PresignResult, error)
